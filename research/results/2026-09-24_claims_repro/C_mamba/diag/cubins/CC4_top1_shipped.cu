  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(cb_desc, mbarrier[(k % 3)], (&(((half_t*)cb_shared)[((k % 3) * 4096)])), (k * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 6), (((int)blockIdx.z) & 63));
      }
      mbarrier[((k % 3) + 15)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cs_k_shared)[((k % 3) * 64)])), (&(dA_cumsum[(((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 64))])), mbarrier[((k % 3) + 3)], 128);
      }
      mbarrier[((k % 3) + 18)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 6)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[((k % 3) * 64)])), (&(dt[(((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 64))])), mbarrier[((k % 3) + 6)], 128);
      }
      mbarrier[((k % 3) + 21)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(x_desc, mbarrier[((k % 3) + 9)], (&(((half_t*)x_shared)[((k % 3) * 4096)])), 0, (((((int)blockIdx.z) >> 6) * 256) + (k * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 63));
      }
    }
  } else {
    #pragma unroll
