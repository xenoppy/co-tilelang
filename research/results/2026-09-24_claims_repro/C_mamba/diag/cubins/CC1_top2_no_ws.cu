...
extern "C" __global__ void __launch_bounds__(128, 1) chunk_scan_fwd_kernel(const half_t* __restrict__ C, const half_t* __restrict__ D, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ cb, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ prev_states, const half_t* __restrict__ x) {
  ...
  *(float4*)(scale_m_local + 0) = __1;
  ...
  for (int i_8 = 0; i_8 < 8; ++i_8) {
    tl::cp_async_gs<16>((&(((half_t*)cb_shared)[((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_8 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[(((((((int)blockIdx.z) * 65536) + (((int)blockIdx.y) * 16384)) + (i_8 * 2048)) + ((((int)threadIdx.x) >> 4) * 256)) + ((((int)threadIdx.x) & 15) * 8))])));
  }
  tl::cp_async_commit();
  __syncthreads();
  ...
  for (int k = 0; k < 1; ++k) {
    ...
    for (int i_10 = 0; i_10 < 16; ++i_10) {
      tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((((i_10 >> 3) * 4096) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + ((i_10 & 1) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((i_10 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_10 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb_local[(i_10 * 8)])));
    }
    __syncthreads();
    #pragma unroll
    for (int i_11 = 0; i_11 < 8; ++i_11) {
      tl::cp_async_gs<16>((&(((half_t*)cb_shared)[((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_11 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[((((((((int)blockIdx.z) * 65536) + (((int)blockIdx.y) * 16384)) + (i_11 * 2048)) + ((((int)threadIdx.x) >> 4) * 256)) + ((((int)threadIdx.x) & 15) * 8)) + 128)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<3>();
    __syncthreads();
    ...
    __syncthreads();
    ((half_t*)dA_cs_k_shared)[((int)threadIdx.x)] = dA_cumsum[((((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + ((int)threadIdx.x)) + 128)];
    tl::cp_async_commit();
    #pragma unroll
    ...
    __syncthreads();
    ((half_t*)dt_shared)[((int)threadIdx.x)] = dt[((((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + ((int)threadIdx.x)) + 128)];
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_16 = 0; i_16 < 128; ++i_16) {
      half_t condval;
      if (((((((i_16 >> 4) * 16) + (((i_16 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_16 & 1)) <= (((((((int)blockIdx.y) * 64) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (((i_16 & 15) >> 3) * 16)) + (((i_16 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
        condval = cb_local[i_16];
      } else {
        condval = half_t(0x0p+0f/*0.000000e+00*/);
      }
      cb_local[i_16] = condval;
    }
    tl::cp_async_wait<3>();
    __syncthreads();
    {
    ...
    for (int i_19 = 0; i_19 < 8; ++i_19) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((i_19 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[((((((((int)blockIdx.z) * 1048576) + (i_19 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 524288)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<3>();
  ...
  for (int i_20 = 0; i_20 < 16; ++i_20) {
    tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((((i_20 >> 3) * 4096) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + ((i_20 & 1) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((i_20 & 7) >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_20 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb_local[(i_20 * 8)])));
  }
  tl::cp_async_wait<2>();
  __syncthreads();
  #pragma unroll
  ...
  for (int i_25 = 0; i_25 < 128; ++i_25) {
    half_t condval_1;
    if ((((((((((int)blockIdx.y) >> 1) * 128) + ((i_25 >> 4) * 16)) + (((i_25 & 7) >> 2) * 8)) + ((((int)threadIdx.x) & 3) * 2)) + (i_25 & 1)) <= (((((((int)blockIdx.y) * 64) + (((((int)threadIdx.x) & 63) >> 5) * 32)) + (((i_25 & 15) >> 3) * 16)) + (((i_25 & 3) >> 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)))) {
  ...
  for (int i_28 = 0; i_28 < 4; ++i_28) {
    *(uint4*)(((half_t*)x_residual_shared) + (((((i_28 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(x + ((((((((int)blockIdx.z) * 1048576) + (((int)blockIdx.y) * 262144)) + (i_28 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
  }
  __syncthreads();
  #pragma unroll
