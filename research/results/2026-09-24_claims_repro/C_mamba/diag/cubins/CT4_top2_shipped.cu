...
extern "C" __global__ void __launch_bounds__(256, 1) chunk_state_fwd_kernel(__grid_constant__ const CUtensorMap B_desc, half_t* __restrict__ Output, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, __grid_constant__ const CUtensorMap x_desc) {
  ...
  void* dA_cumsum_shared = ((void*)((char*)buf_dyn_shmem + 73728));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 4; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(x_desc, mbarrier[(k % 3)], (&(((half_t*)x_shared)[((k % 3) * 4096)])), 0, (((((int)blockIdx.z) >> 6) * 256) + (k * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 63));
      }
      mbarrier[((k % 3) + 15)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cumsum_shared)[((k % 3) * 64)])), (&(dA_cumsum[(((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 64))])), mbarrier[((k % 3) + 3)], 128);
      }
      ...
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 9)].arrive_and_expect_tx(16384);
        #pragma unroll
        for (int i = 0; i < 2; ++i) {
          tl::tma_load(B_desc, mbarrier[((k % 3) + 9)], (&(((half_t*)B_shared)[(((k % 3) * 8192) + (i * 4096))])), (i * 64), (((((int)blockIdx.z) >> 6) * 256) + (k * 64)), 0, (((int)blockIdx.z) & 63));
        }
      }
    }
  } else {
    ...
    for (int k_1 = 0; k_1 < 4; ++k_1) {
      ...
      for (int i_2 = 0; i_2 < 8; ++i_2) {
        ...
        *(uint1*)(dA_cumsum_shared_local_cast + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + ((((k_1 % 3) * 64) + (i_2 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __1;
      ...
      for (int i_3 = 0; i_3 < 8; ++i_3) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((k_1 % 3) * 64) + (i_3 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __2;
      ...
      for (int i_5 = 0; i_5 < 64; ++i_5) {
        x_local[i_5] = ((half_t*)x_shared)[(((((((((k_1 % 3) * 4096) + ((i_5 >> 3) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_5 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_5 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_5 & 7) >> 2) + (i_5 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
      }
      ...
      mbarrier[((k_1 % 3) + 9)].wait((k_1 / 3));
      {
        ...
        for (int ki = 0; ki < 4; ++ki) {
          ...
          for (int i_7 = 0; i_7 < 4; ++i_7) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[((((((((k_1 % 3) * 8192) + (((((int)threadIdx.x) & 127) >> 6) * 4096)) + (ki * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_7 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_7 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local[(i_7 * 8)])));
          }
