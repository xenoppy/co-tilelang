...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const half_t* __restrict__ C, const half_t* __restrict__ D, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ cb, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ prev_states, const half_t* __restrict__ x) {
  ...
  for (int i_3 = 0; i_3 < 16; ++i_3) {
    *(uint4*)(((half_t*)C_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_3 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(C + ((((((((int)blockIdx.z) & 7) * 1048576) + ((((int)blockIdx.z) >> 3) * 32768)) + (((int)blockIdx.y) * 16384)) + (i_3 * 1024)) + (((int)threadIdx.x) * 8)));
  }
  #pragma unroll
  for (int i_4 = 0; i_4 < 8; ++i_4) {
    *(uint4*)(((half_t*)prev_state_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_4 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(prev_states + ((((((((int)blockIdx.z) & 7) * 20971520) + ((((int)blockIdx.z) >> 3) * 655360)) + (((int)blockIdx.x) * 8192)) + (i_4 * 1024)) + (((int)threadIdx.x) * 8)));
  }
  {
    half_t A_local[32];
    half_t B_local[16];
  ...
  for (int i_9 = 0; i_9 < 8; ++i_9) {
    tl::cp_async_gs<16>((&(((half_t*)cb_shared)[(((((i_9 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[(((((((((int)blockIdx.z) & 7) * 2097152) + ((((int)blockIdx.z) >> 3) * 65536)) + (((int)blockIdx.y) * 32768)) + (i_9 * 4096)) + ((((int)threadIdx.x) >> 3) * 256)) + ((((int)threadIdx.x) & 7) * 8))])));
  }
  tl::cp_async_commit();
  __syncthreads();
  ...
  for (int i_10 = 0; i_10 < 4; ++i_10) {
    tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((i_10 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[(((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (i_10 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8))])));
  }
  tl::cp_async_commit();
  for (int k = 0; k < ((((int)blockIdx.y) * 2) + 1); ++k) {
    ...
    for (int i_12 = 0; i_12 < 8; ++i_12) {
      tl::cp_async_gs<16>((&(((half_t*)cb_shared)[(((((i_12 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[(((((((((((int)blockIdx.z) & 7) * 2097152) + ((((int)blockIdx.z) >> 3) * 65536)) + (((int)blockIdx.y) * 32768)) + (i_12 * 4096)) + ((((int)threadIdx.x) >> 3) * 256)) + (k * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 64)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<3>();
    __syncthreads();
    ...
    for (int i_20 = 0; i_20 < 4; ++i_20) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((i_20 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[(((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (k * 327680)) + (i_20 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 327680)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<3>();
  ...
  for (int i_29 = 0; i_29 < 8; ++i_29) {
    *(uint4*)(((half_t*)x_residual_shared) + (((((i_29 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(x + ((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (((int)blockIdx.y) * 655360)) + (i_29 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
  }
  __syncthreads();
  #pragma unroll
