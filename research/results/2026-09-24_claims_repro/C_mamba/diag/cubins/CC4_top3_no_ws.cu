  ...
  *(float4*)(scale_m_local + 0) = __1;
  ...
  for (int k = 0; k < ((int)blockIdx.y); ++k) {
    ...
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      tl::cp_async_gs<16>((&(((half_t*)cb_shared)[(((((i_11 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[(((((((((((int)blockIdx.z) & 63) * 524288) + ((((int)blockIdx.z) >> 6) * 65536)) + (((int)blockIdx.y) * 16384)) + (i_11 * 4096)) + ((((int)threadIdx.x) >> 3) * 256)) + (k * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 64)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<3>();
    __syncthreads();
    ...
    __syncthreads();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dA_cs_k_shared)[((int)threadIdx.x)] = dA_cumsum[(((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 64)) + ((int)threadIdx.x)) + 64)];
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    __syncthreads();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dt_shared)[((int)threadIdx.x)] = dt[(((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 64)) + ((int)threadIdx.x)) + 64)];
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_19 = 0; i_19 < 4; ++i_19) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((i_19 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[(((((((((((int)blockIdx.z) & 63) * 8388608) + ((((int)blockIdx.z) >> 6) * 1048576)) + (k * 262144)) + (i_19 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<3>();
  ...
  for (int i_28 = 0; i_28 < 4; ++i_28) {
    *(uint4*)(((half_t*)x_residual_shared) + (((((i_28 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(x + ((((((((((int)blockIdx.z) & 63) * 8388608) + ((((int)blockIdx.z) >> 6) * 1048576)) + (((int)blockIdx.y) * 262144)) + (i_28 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
  }
  __syncthreads();
  #pragma unroll
