  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(cb_desc, mbarrier[(k % 3)], (&(((half_t*)cb_shared)[((k % 3) * 4096)])), (k * 64), (((int)blockIdx.y) * 64), 0, ((int)blockIdx.z), 0);
      }
      mbarrier[((k % 3) + 15)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cs_k_shared)[((k % 3) * 64)])), (&(dA_cumsum[(((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + (k * 64))])), mbarrier[((k % 3) + 3)], 128);
      }
      mbarrier[((k % 3) + 18)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 6)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[((k % 3) * 64)])), (&(dt[(((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + (k * 64))])), mbarrier[((k % 3) + 6)], 128);
      }
      mbarrier[((k % 3) + 21)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(x_desc, mbarrier[((k % 3) + 9)], (&(((half_t*)x_shared)[((k % 3) * 4096)])), 0, ((((int)blockIdx.z) * 256) + (k * 64)), ((int)blockIdx.x), 0);
      }
    }
  } else {
    #pragma unroll
    ...
    *(float4*)(scale_m_local + 0) = __1;
    ...
    for (int i_16 = 0; i_16 < 4; ++i_16) {
      *(uint4*)(((half_t*)x_residual_shared) + ((((((i_16 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) - 1024)) = *(uint4*)(x + (((((((((int)blockIdx.z) * 1048576) + (((int)blockIdx.y) * 262144)) + (i_16 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) - 65536));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
