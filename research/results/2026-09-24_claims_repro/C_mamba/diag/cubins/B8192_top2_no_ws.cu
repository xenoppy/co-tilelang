...
extern "C" __global__ void __launch_bounds__(128, 1) main_kernel(const half_t* __restrict__ C, const half_t* __restrict__ D, __grid_constant__ const CUtensorMap Output_desc, const half_t* __restrict__ cb, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ prev_states, const half_t* __restrict__ x) {
  ...
  *(float4*)(scale_m_local + 0) = __1;
  ...
  if (0 < ((int)blockIdx.y)) {
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dA_cs_k_shared)[(((int)threadIdx.x) + 64)] = dA_cumsum[((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + ((int)threadIdx.x)) + 64)];
    }
    tl::cp_async_commit();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dt_shared)[(((int)threadIdx.x) + 64)] = dt[((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + ((int)threadIdx.x)) + 64)];
    }
    tl::cp_async_commit();
  }
  __syncthreads();
  if (0 < ((int)blockIdx.y)) {
    ...
    for (int i_11 = 0; i_11 < 4; ++i_11) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((i_11 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(x[((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (i_11 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 327680)])));
    }
    tl::cp_async_commit();
  }
  if (1 < ((int)blockIdx.y)) {
    ...
    for (int i_12 = 0; i_12 < 4; ++i_12) {
      tl::cp_async_gs<16>((&(((half_t*)cb_shared)[((((((i_12 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(cb[((((((((((int)blockIdx.z) & 7) * 2097152) + ((((int)blockIdx.z) >> 3) * 65536)) + (((int)blockIdx.y) * 16384)) + (i_12 * 4096)) + ((((int)threadIdx.x) >> 3) * 256)) + ((((int)threadIdx.x) & 7) * 8)) + 128)])));
    }
    tl::cp_async_commit();
  }
  __syncthreads();
  if (1 < ((int)blockIdx.y)) {
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dA_cs_k_shared)[(((int)threadIdx.x) + 128)] = dA_cumsum[((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + ((int)threadIdx.x)) + 128)];
    }
    tl::cp_async_commit();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dt_shared)[(((int)threadIdx.x) + 128)] = dt[((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + ((int)threadIdx.x)) + 128)];
    }
    tl::cp_async_commit();
  }
  __syncthreads();
  if (1 < ((int)blockIdx.y)) {
    ...
    for (int i_13 = 0; i_13 < 4; ++i_13) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((i_13 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(x[((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (i_13 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 655360)])));
    }
    tl::cp_async_commit();
  }
  for (int k = 0; k < (((int)blockIdx.y) - 2); ++k) {
    ...
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      tl::cp_async_gs<16>((&(((half_t*)cb_shared)[((((((k * 4096) + (i_15 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb[(((((((((((int)blockIdx.z) & 7) * 2097152) + ((((int)blockIdx.z) >> 3) * 65536)) + (((int)blockIdx.y) * 16384)) + (i_15 * 4096)) + ((((int)threadIdx.x) >> 3) * 256)) + (k * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 192)])));
    }
    tl::cp_async_commit();
    tl::cp_async_wait<11>();
    __syncthreads();
    ...
    __syncthreads();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dA_cs_k_shared)[((k * 64) + ((int)threadIdx.x))] = dA_cumsum[(((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64)) + ((int)threadIdx.x)) + 192)];
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    __syncthreads();
    if (((int)threadIdx.x) < 64) {
      ((half_t*)dt_shared)[((k * 64) + ((int)threadIdx.x))] = dt[(((((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64)) + ((int)threadIdx.x)) + 192)];
    }
    tl::cp_async_commit();
    #pragma unroll
    ...
    for (int i_23 = 0; i_23 < 4; ++i_23) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((k * 4096) + (i_23 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[(((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (k * 327680)) + (i_23 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 983040)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<11>();
  ...
  for (int i_46 = 0; i_46 < 4; ++i_46) {
    *(uint4*)(((half_t*)x_residual_shared) + (((((i_46 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(x + ((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (((int)blockIdx.y) * 327680)) + (i_46 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)));
  }
  __syncthreads();
  #pragma unroll
