...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const half_t* __restrict__ C, const half_t* __restrict__ D, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap cb_desc, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ prev_states, const half_t* __restrict__ x, __grid_constant__ const CUtensorMap x_desc) {
  ...
  void* dA_cs_k_shared = ((void*)((char*)buf_dyn_shmem + 50176));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(cb_desc, mbarrier[0], (&(((half_t*)cb_shared)[0])), (k * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
    ...
    *(float4*)(scale_m_local + 0) = __1;
    ...
    for (int k_1 = 0; k_1 < (((int)blockIdx.y) + 1); ++k_1) {
      ...
      for (int i_8 = 0; i_8 < 8; ++i_8) {
        tl::ptx_ldmatrix_x4((&(((half_t*)cb_shared)[((((((((((int)threadIdx.x) & 63) >> 5) * 2048) + ((i_8 & 1) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + ((((i_8 >> 2) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((i_8 & 3) >> 1) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(cb_local[(i_8 * 8)])));
      }
      mbarrier[4].arrive();
      ...
      for (int i_9 = 0; i_9 < 8; ++i_9) {
        ...
        *(uint1*)(dA_cs_k_shared_local_cast + 0) = *(uint1*)(((half_t*)dA_cs_k_shared) + ((i_9 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
      ...
      for (int i_11 = 0; i_11 < 8; ++i_11) {
        ...
        *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((i_11 * 8) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __11;
      ...
      mbarrier[3].wait((k_1 & 1));
      {
        ...
        for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
          ...
          for (int i_14 = 0; i_14 < 2; ++i_14) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)x_shared)[(((((ki_1 * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_14) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_1[(i_14 * 8)])));
          }
