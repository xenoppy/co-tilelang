...
extern "C" __global__ void __launch_bounds__(128, 1) chunk_state_fwd_kernel(const half_t* __restrict__ B, half_t* __restrict__ Output, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ x) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 192));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 384));
  void* B_shared = ((void*)((char*)buf_dyn_shmem + 12672));
  float dA_cs_last[1];
  float acc_o[64];
  ...
  for (int i_2 = 0; i_2 < 4; ++i_2) {
    tl::cp_async_gs<16>((&(((half_t*)B_shared)[((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_2 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B[(((((((int)blockIdx.z) & 63) * 262144) + ((((int)blockIdx.z) >> 6) * 32768)) + (i_2 * 1024)) + (((int)threadIdx.x) * 8))])));
  }
  tl::cp_async_commit();
  __syncthreads();
  if (((int)threadIdx.x) < 32) {
    ((half_t*)dA_cumsum_shared)[(((int)threadIdx.x) + 32)] = dA_cumsum[((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + ((int)threadIdx.x)) + 32)];
  }
  tl::cp_async_commit();
  if (((int)threadIdx.x) < 32) {
    ((half_t*)dt_shared)[(((int)threadIdx.x) + 32)] = dt[((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + ((int)threadIdx.x)) + 32)];
  }
  tl::cp_async_commit();
  __syncthreads();
  #pragma unroll
  for (int i_3 = 0; i_3 < 2; ++i_3) {
    tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((i_3 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 2048)])), (&(x[((((((((((int)blockIdx.z) & 63) * 8388608) + ((((int)blockIdx.z) >> 6) * 1048576)) + (i_3 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 131072)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_4 = 0; i_4 < 4; ++i_4) {
    tl::cp_async_gs<16>((&(((half_t*)B_shared)[(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_4 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(B[((((((((int)blockIdx.z) & 63) * 262144) + ((((int)blockIdx.z) >> 6) * 32768)) + (i_4 * 1024)) + (((int)threadIdx.x) * 8)) + 4096)])));
  }
  tl::cp_async_commit();
  __syncthreads();
  if (((int)threadIdx.x) < 32) {
  ...
  for (int i_5 = 0; i_5 < 2; ++i_5) {
    tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((i_5 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(x[((((((((((int)blockIdx.z) & 63) * 8388608) + ((((int)blockIdx.z) >> 6) * 1048576)) + (i_5 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 262144)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_6 = 0; i_6 < 4; ++i_6) {
    tl::cp_async_gs<16>((&(((half_t*)B_shared)[(((((((((((int)threadIdx.x) & 15) >> 3) * 2048) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(B[((((((((int)blockIdx.z) & 63) * 262144) + ((((int)blockIdx.z) >> 6) * 32768)) + (i_6 * 1024)) + (((int)threadIdx.x) * 8)) + 8192)])));
  }
  tl::cp_async_commit();
  for (int k = 0; k < 5; ++k) {
    tl::cp_async_wait<11>();
    ...
    for (int i_7 = 0; i_7 < 4; ++i_7) {
      ...
      *(uint1*)(dA_cumsum_shared_local_cast + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + ((((k % 3) * 32) + (i_7 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __1;
      uint1 v_ = *(uint1*)(dA_cumsum_shared_local_cast + 0);
      ((float2*)(&__1))[0] = __half22float2(((half2*)(&v_))[0]);
      *(float2*)(dA_cumsum_local + (i_7 * 2)) = __1;
    }
    __syncthreads();
    if (((int)threadIdx.x) < 32) {
      ((half_t*)dA_cumsum_shared)[(((k % 3) * 32) + ((int)threadIdx.x))] = dA_cumsum[(((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 32)) + ((int)threadIdx.x)) + 96)];
    }
    tl::cp_async_commit();
    tl::cp_async_wait<11>();
    __syncthreads();
    ...
    for (int i_8 = 0; i_8 < 4; ++i_8) {
      ...
      *(uint1*)(dt_shared_local_cast_1 + 0) = *(uint1*)(((half_t*)dt_shared) + ((((k % 3) * 32) + (i_8 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      float2 __2;
    ...
    __syncthreads();
    if (((int)threadIdx.x) < 32) {
      ((half_t*)dt_shared)[(((k % 3) * 32) + ((int)threadIdx.x))] = dt[(((((((((int)blockIdx.z) & 63) * 131072) + (((int)blockIdx.x) * 2048)) + ((((int)blockIdx.z) >> 6) * 256)) + (k * 32)) + ((int)threadIdx.x)) + 96)];
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_9 = 0; i_9 < 2; ++i_9) {
      ...
      float4 __3;
        ...
        float4 __5;
          ...
          float4 __6;
            float4 v__3 = *(float4*)(dA_cumsum_local + (i_9 * 4));
        ...
        __4.z = exp2f(__5.z);
        __4.w = exp2f(__5.w);
        float4 v__5 = *(float4*)(dt_local + (i_9 * 4));
        *(float2*)(&(__3.x)) = tl::mul2(*(float2*)(&(__4.x)), *(float2*)(&(v__5.x)));
        *(float2*)(&(__3.z)) = tl::mul2(*(float2*)(&(__4.z)), *(float2*)(&(v__5.z)));
      *(float4*)(scale + (i_9 * 4)) = __3;
    }
    tl::cp_async_wait<11>();
    __syncthreads();
    #pragma unroll
    for (int i_10 = 0; i_10 < 32; ++i_10) {
      x_local[i_10] = ((half_t*)x_shared)[(((((((((k % 3) * 2048) + ((i_10 >> 3) * 512)) + ((((int)threadIdx.x) & 3) * 128)) + (((i_10 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_10 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_10 & 7) >> 2) + (i_10 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
    }
    __syncthreads();
    #pragma unroll
    for (int i_11 = 0; i_11 < 2; ++i_11) {
      tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((((k % 3) * 2048) + (i_11 * 1024)) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[(((((((((((int)blockIdx.z) & 63) * 8388608) + ((((int)blockIdx.z) >> 6) * 1048576)) + (k * 131072)) + (i_11 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 393216)])));
    }
    tl::cp_async_commit();
    #pragma unroll
    for (int i_12 = 0; i_12 < 32; ++i_12) {
      xt_local[i_12] = ((half_t)(((float)x_local[((((((i_12 >> 4) * 16) + (((i_12 & 7) >> 2) * 8)) + ((i_12 & 1) * 4)) + (((i_12 & 15) >> 3) * 2)) + ((i_12 & 3) >> 1))]) * scale[((((i_12 >> 4) * 4) + (((i_12 & 7) >> 2) * 2)) + (i_12 & 1))]));
    }
    tl::cp_async_wait<11>();
    __syncthreads();
    {
      ...
      for (int ki = 0; ki < 2; ++ki) {
        ...
        for (int i_13 = 0; i_13 < 4; ++i_13) {
          tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[((((((((k % 3) * 4096) + ((((int)threadIdx.x) >> 6) * 2048)) + (ki * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local[(i_13 * 8)])));
        }
        for (int i_14 = 0; i_14 < 2; ++i_14) {
          for (int j = 0; j < 4; ++j) {
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + ((i_14 * 32) + (j * 8))), reinterpret_cast<const unsigned*>(xt_local + ((ki * 16) + (i_14 * 8))), reinterpret_cast<const unsigned*>(B_local + (j * 8)));
            tl::mma_sync<tl::DataType::kFloat16, tl::DataType::kFloat16, tl::DataType::kFloat32, 16, 8, 16, false, true>(reinterpret_cast<float*>(acc_o + (((i_14 * 32) + (j * 8)) + 4)), reinterpret_cast<const unsigned*>(xt_local + ((ki * 16) + (i_14 * 8))), reinterpret_cast<const unsigned*>(B_local + ((j * 8) + 4)));
          }
        }
      }
    }
    ...
    for (int i_15 = 0; i_15 < 4; ++i_15) {
      tl::cp_async_gs<16>((&(((half_t*)B_shared)[((((((((k % 3) * 4096) + (((((int)threadIdx.x) & 15) >> 3) * 2048)) + (i_15 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B[(((((((((int)blockIdx.z) & 63) * 262144) + ((((int)blockIdx.z) >> 6) * 32768)) + (k * 4096)) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) + 12288)])));
    }
    tl::cp_async_commit();
  }
  tl::cp_async_wait<11>();
  ...
  __syncthreads();
  {
    ...
    for (int ki_1 = 0; ki_1 < 2; ++ki_1) {
      ...
      for (int i_21 = 0; i_21 < 4; ++i_21) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[((((((((((int)threadIdx.x) >> 6) * 2048) + (ki_1 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_21 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_21 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(B_local_1[(i_21 * 8)])));
      }
  ...
  for (int i_23 = 0; i_23 < 4; ++i_23) {
    ...
    *(uint1*)(dA_cumsum_shared_local_cast_4 + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + ((i_23 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __13;
  ...
  for (int i_26 = 0; i_26 < 32; ++i_26) {
    x_local[i_26] = ((half_t*)x_shared)[((((((((i_26 >> 3) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_26 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_26 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_26 & 7) >> 2) + (i_26 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
  }
  #pragma unroll
  ...
  __syncthreads();
  {
    ...
    for (int ki_2 = 0; ki_2 < 2; ++ki_2) {
      ...
      for (int i_28 = 0; i_28 < 4; ++i_28) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[(((((((((int)threadIdx.x) >> 6) * 2048) + (ki_2 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_28 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_28 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_2[(i_28 * 8)])));
      }
  ...
  for (int i_30 = 0; i_30 < 4; ++i_30) {
    ...
    *(uint1*)(dA_cumsum_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + (((i_30 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
    float2 __19;
  ...
  for (int i_31 = 0; i_31 < 4; ++i_31) {
    ...
    *(uint1*)(dt_shared_local_cast_7 + 0) = *(uint1*)(((half_t*)dt_shared) + (((i_31 * 8) + ((((int)threadIdx.x) & 3) * 2)) + 32));
    float2 __20;
  ...
  for (int i_33 = 0; i_33 < 32; ++i_33) {
    x_local[i_33] = ((half_t*)x_shared)[(((((((((i_33 >> 3) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_33 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_33 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_33 & 7) >> 2) + (i_33 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2)) + 2048)];
  }
  #pragma unroll
  ...
  __syncthreads();
  {
    ...
    for (int ki_3 = 0; ki_3 < 2; ++ki_3) {
      ...
      for (int i_35 = 0; i_35 < 4; ++i_35) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[((((((((((int)threadIdx.x) >> 6) * 2048) + (ki_3 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_35 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_35 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 4096)])), (&(B_local_3[(i_35 * 8)])));
      }
