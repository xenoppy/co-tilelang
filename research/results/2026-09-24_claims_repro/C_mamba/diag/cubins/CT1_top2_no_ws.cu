...
extern "C" __global__ void __launch_bounds__(128, 1) chunk_state_fwd_kernel(const half_t* __restrict__ B, half_t* __restrict__ Output, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ x) {
  ...
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 384));
  void* x_shared = ((void*)((char*)buf_dyn_shmem + 768));
  void* B_shared = ((void*)((char*)buf_dyn_shmem + 25344));
  float dA_cs_last[1];
  float acc_o[64];
  ...
  __syncthreads();
  if (((int)threadIdx.x) < 64) {
    ((half_t*)dA_cumsum_shared)[(((int)threadIdx.x) + 128)] = dA_cumsum[((((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + ((int)threadIdx.x)) + 128)];
  }
  tl::cp_async_commit();
  if (((int)threadIdx.x) < 64) {
  ...
  for (int i_5 = 0; i_5 < 4; ++i_5) {
    tl::cp_async_gs<16>((&(((half_t*)x_shared)[((((((i_5 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 8192)])), (&(x[((((((((int)blockIdx.z) * 1048576) + (i_5 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 524288)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  for (int i_6 = 0; i_6 < 8; ++i_6) {
    tl::cp_async_gs<16>((&(((half_t*)B_shared)[(((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_6 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) + 16384)])), (&(B[((((((int)blockIdx.z) * 32768) + (i_6 * 1024)) + (((int)threadIdx.x) * 8)) + 16384)])));
  }
  tl::cp_async_commit();
  tl::cp_async_wait<11>();
  __syncthreads();
  ...
  for (int i_7 = 0; i_7 < 8; ++i_7) {
    ...
    *(uint1*)(dA_cumsum_shared_local_cast + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + ((i_7 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __1;
  ...
  __syncthreads();
  if (((int)threadIdx.x) < 64) {
    ((half_t*)dA_cumsum_shared)[((int)threadIdx.x)] = dA_cumsum[((((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + ((int)threadIdx.x)) + 192)];
  }
  tl::cp_async_commit();
  tl::cp_async_wait<11>();
  __syncthreads();
  ...
  __syncthreads();
  if (((int)threadIdx.x) < 64) {
    ((half_t*)dt_shared)[((int)threadIdx.x)] = dt[((((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + ((int)threadIdx.x)) + 192)];
  }
  tl::cp_async_commit();
  #pragma unroll
  ...
  for (int i_10 = 0; i_10 < 64; ++i_10) {
    x_local[i_10] = ((half_t*)x_shared)[((((((((i_10 >> 3) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_10 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_10 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_10 & 7) >> 2) + (i_10 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
  }
  __syncthreads();
  #pragma unroll
  for (int i_11 = 0; i_11 < 4; ++i_11) {
    tl::cp_async_gs<16>((&(((half_t*)x_shared)[(((((i_11 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(x[((((((((int)blockIdx.z) * 1048576) + (i_11 * 65536)) + ((((int)threadIdx.x) >> 3) * 4096)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) + 786432)])));
  }
  tl::cp_async_commit();
  #pragma unroll
  ...
  __syncthreads();
  {
    ...
    for (int ki = 0; ki < 4; ++ki) {
      ...
      for (int i_13 = 0; i_13 < 4; ++i_13) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[(((((((((int)threadIdx.x) >> 6) * 4096) + (ki * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_13 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_13 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local[(i_13 * 8)])));
      }
  ...
  for (int i_15 = 0; i_15 < 8; ++i_15) {
    tl::cp_async_gs<16>((&(((half_t*)B_shared)[((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_15 * 512)) + ((((int)threadIdx.x) >> 4) * 64)) + ((((((int)threadIdx.x) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B[((((((int)blockIdx.z) * 32768) + (i_15 * 1024)) + (((int)threadIdx.x) * 8)) + 24576)])));
  }
  tl::cp_async_commit();
  tl::cp_async_wait<11>();
  __syncthreads();
  ...
  for (int i_30 = 0; i_30 < 8; ++i_30) {
    ...
    *(uint1*)(dA_cumsum_shared_local_cast_6 + 0) = *(uint1*)(((half_t*)dA_cumsum_shared) + ((i_30 * 8) + ((((int)threadIdx.x) & 3) * 2)));
    float2 __19;
  ...
  for (int i_33 = 0; i_33 < 64; ++i_33) {
    x_local[i_33] = ((half_t*)x_shared)[((((((((i_33 >> 3) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((i_33 & 7) >> 2) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 32)) + (((((i_33 & 3) >> 1) + (((int)threadIdx.x) & 1)) & 1) * 16)) + (((((i_33 & 7) >> 2) + (i_33 & 1)) & 1) * 8)) + ((((int)threadIdx.x) & 31) >> 2))];
  }
  #pragma unroll
  ...
  __syncthreads();
  {
    ...
    for (int ki_3 = 0; ki_3 < 4; ++ki_3) {
      ...
      for (int i_35 = 0; i_35 < 4; ++i_35) {
        tl::ptx_ldmatrix_x4_trans((&(((half_t*)B_shared)[(((((((((int)threadIdx.x) >> 6) * 4096) + (ki_3 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (i_35 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_35 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_3[(i_35 * 8)])));
      }
