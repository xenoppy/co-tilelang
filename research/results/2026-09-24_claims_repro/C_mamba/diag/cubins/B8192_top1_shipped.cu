  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(cb_desc, mbarrier[(k & 1)], (&(((half_t*)cb_shared)[((k & 1) * 4096)])), (k * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      mbarrier[((k & 1) + 10)].wait(((k >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 2)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cs_k_shared)[((k & 1) * 64)])), (&(dA_cumsum[(((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64))])), mbarrier[((k & 1) + 2)], 128);
      }
      mbarrier[((k & 1) + 12)].wait(((k >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 4)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[((k & 1) * 64)])), (&(dt[(((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64))])), mbarrier[((k & 1) + 4)], 128);
      }
      mbarrier[((k & 1) + 14)].wait(((k >> 1) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k & 1) + 6)].arrive_and_expect_tx(8192);
        tl::tma_load(x_desc, mbarrier[((k & 1) + 6)], (&(((half_t*)x_shared)[((k & 1) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (k * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  } else {
    #pragma unroll
