  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 4; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(x_desc, mbarrier[(k % 3)], (&(((half_t*)x_shared)[((k % 3) * 4096)])), 0, ((((int)blockIdx.z) * 256) + (k * 64)), ((int)blockIdx.x), 0);
      }
      mbarrier[((k % 3) + 15)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cumsum_shared)[((k % 3) * 64)])), (&(dA_cumsum[(((((int)blockIdx.x) * 2048) + (((int)blockIdx.z) * 256)) + (k * 64))])), mbarrier[((k % 3) + 3)], 128);
      }
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        #pragma unroll
        for (int i = 0; i < 2; ++i) {
          tl::tma_load(B_desc, mbarrier[((k % 3) + 9)], (&(((half_t*)B_shared)[(((k % 3) * 8192) + (i * 4096))])), (i * 64), ((((int)blockIdx.z) * 256) + (k * 64)), 0, 0);
        }
      }
    }
  } else {
