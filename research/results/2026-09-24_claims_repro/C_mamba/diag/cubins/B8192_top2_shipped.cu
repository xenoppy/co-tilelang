...
extern "C" __global__ void __launch_bounds__(256, 1) main_kernel(const half_t* __restrict__ C, const half_t* __restrict__ D, __grid_constant__ const CUtensorMap Output_desc, __grid_constant__ const CUtensorMap cb_desc, const half_t* __restrict__ dA_cumsum, const half_t* __restrict__ dt, const half_t* __restrict__ prev_states, const half_t* __restrict__ x, __grid_constant__ const CUtensorMap x_desc) {
  ...
  void* dA_cs_k_shared = ((void*)((char*)buf_dyn_shmem + 82944));
  void* dt_shared = ((void*)((char*)buf_dyn_shmem + 83968));
  __shared__ __align__(16) uint64_t mbarrier_mem[24];
  ...
  #pragma unroll
  for (int i = 0; i < 4; ++i) {
    *(uint4*)(((half_t*)C_shared) + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = *(uint4*)(C + ((((((((int)blockIdx.z) & 7) * 1048576) + ((((int)blockIdx.z) >> 3) * 32768)) + (((int)blockIdx.y) * 8192)) + (i * 2048)) + (((int)threadIdx.x) * 8)));
  }
  #pragma unroll
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < (((int)blockIdx.y) + 1); ++k) {
      mbarrier[((k % 3) + 12)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[(k % 3)].arrive_and_expect_tx(8192);
        tl::tma_load(cb_desc, mbarrier[(k % 3)], (&(((half_t*)cb_shared)[((k % 3) * 4096)])), (k * 64), (((int)blockIdx.y) * 64), 0, (((int)blockIdx.z) >> 3), (((int)blockIdx.z) & 7));
      }
      mbarrier[((k % 3) + 15)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 3)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dA_cs_k_shared)[((k % 3) * 64)])), (&(dA_cumsum[(((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64))])), mbarrier[((k % 3) + 3)], 128);
      }
      mbarrier[((k % 3) + 18)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 6)].arrive_and_expect_tx(128);
        tl::tma_load((&(((half_t*)dt_shared)[((k % 3) * 64)])), (&(dt[(((((((int)blockIdx.z) & 7) * 655360) + (((int)blockIdx.x) * 8192)) + ((((int)blockIdx.z) >> 3) * 256)) + (k * 64))])), mbarrier[((k % 3) + 6)], 128);
      }
      mbarrier[((k % 3) + 21)].wait(((k / 3) ^ 1));
      if (tl::tl_shuffle_elect<128>()) {
        mbarrier[((k % 3) + 9)].arrive_and_expect_tx(8192);
        tl::tma_load(x_desc, mbarrier[((k % 3) + 9)], (&(((half_t*)x_shared)[((k % 3) * 4096)])), 0, (((((int)blockIdx.z) >> 3) * 256) + (k * 64)), ((int)blockIdx.x), (((int)blockIdx.z) & 7));
      }
    }
  } else {
    #pragma unroll
    ...
    *(float4*)(scale_m_local + 0) = __1;
    ...
    for (int k_1 = 0; k_1 < (((int)blockIdx.y) + 1); ++k_1) {
      ...
      for (int i_8 = 0; i_8 < 32; ++i_8) {
        *(uint1*)(cb_local + (i_8 * 2)) = *(uint1*)(((half_t*)cb_shared) + ((((((((((k_1 % 3) * 4096) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + (((i_8 & 7) >> 2) * 1024)) + ((i_8 & 1) * 512)) + (((((int)threadIdx.x) & 31) >> 2) * 64)) + (((((((i_8 >> 3) * 16) + (((i_8 & 3) >> 1) * 8)) >> 5) + ((((int)threadIdx.x) & 31) >> 4)) & 1) * 32)) + (((((i_8 & 15) >> 3) + ((((int)threadIdx.x) & 15) >> 3)) & 1) * 16)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_8 & 3) >> 1)) & 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)));
      }
      mbarrier[((k_1 % 3) + 12)].arrive();
      mbarrier[((k_1 % 3) + 3)].wait((k_1 / 3));
      #pragma unroll
      for (int i_9 = 0; i_9 < 8; ++i_9) {
        half_t dA_cs_k_shared_local_cast[2];
        *(uint1*)(dA_cs_k_shared_local_cast + 0) = *(uint1*)(((half_t*)dA_cs_k_shared) + ((((k_1 % 3) * 64) + (i_9 * 8)) + ((((int)threadIdx.x) & 3) * 2)));
        float2 __4;
        uint1 v__4 = *(uint1*)(dA_cs_k_shared_local_cast + 0);
        ((float2*)(&__4))[0] = __half22float2(((half2*)(&v__4))[0]);
        *(float2*)(dA_cs_k_local + (i_9 * 2)) = __4;
      }
      mbarrier[((k_1 % 3) + 15)].arrive();
      #pragma unroll
      ...
      mbarrier[((k_1 % 3) + 9)].wait((k_1 / 3));
      {
        half_t B_local_1[16];
        for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
          #pragma unroll
          for (int i_14 = 0; i_14 < 2; ++i_14) {
            tl::ptx_ldmatrix_x4_trans((&(((half_t*)x_shared)[(((((((k_1 % 3) * 4096) + (ki_1 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + i_14) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))])), (&(B_local_1[(i_14 * 8)])));
          }
      ...
      mbarrier[((k_1 % 3) + 21)].arrive();
    }
    D_local[0] = ((float)D[((int)blockIdx.x)]);
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
    for (int i_16 = 0; i_16 < 4; ++i_16) {
      *(uint4*)(((half_t*)x_residual_shared) + ((((((i_16 * 1024) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8)) - 1024)) = *(uint4*)(x + (((((((((((int)blockIdx.z) & 7) * 41943040) + ((((int)blockIdx.z) >> 3) * 1310720)) + (((int)blockIdx.y) * 327680)) + (i_16 * 81920)) + ((((int)threadIdx.x) >> 3) * 5120)) + (((int)blockIdx.x) * 64)) + ((((int)threadIdx.x) & 7) * 8)) - 81920));
    }
    tl::__sync_thread_partial(3, 128);
    #pragma unroll
