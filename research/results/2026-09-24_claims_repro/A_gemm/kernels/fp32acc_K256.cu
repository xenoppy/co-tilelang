...
extern "C" __global__ void __launch_bounds__(384, 1) main_kernel(__grid_constant__ const CUtensorMap A_desc, __grid_constant__ const CUtensorMap B_desc, __grid_constant__ const CUtensorMap C_desc) {
  ...
  void* A_shared = ((void*)((char*)buf_dyn_shmem + 32768));
  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k = 0; k < 8; ++k) {
      ...
      if (tl::tl_shuffle_elect<128>()) {
        ...
        tl::tma_load(A_desc, mbarrier[(k & 1)], (&(((half_t*)A_shared)[((k & 1) * 4096)])), (k * 32), (((int)blockIdx.y) * 128));
        mbarrier[(k & 1)].arrive_and_expect_tx(16384);
        tl::tma_load(B_desc, mbarrier[(k & 1)], (&(((half_t*)B_shared)[((k & 1) * 8192)])), (k * 32), (((int)blockIdx.x) * 256));
      }
    }
  } else {
      ...
      mbarrier[(k_1 & 1)].wait(((k_1 & 3) >> 1));
      {
        ...
        for (int ki = 0; ki < 2; ++ki) {
          ...
          for (int i_1 = 0; i_1 < 4; ++i_1) {
            tl::ptx_ldmatrix_x4((&(((half_t*)A_shared)[(((((((k_1 & 1) * 4096) + (((((int)threadIdx.x) & 63) >> 5) * 2048)) + (i_1 * 512)) + ((((int)threadIdx.x) & 15) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + ki) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(A_local[(i_1 * 8)])));
          }
          #pragma unroll
          for (int i_2 = 0; i_2 < 4; ++i_2) {
            tl::ptx_ldmatrix_x4((&(((half_t*)B_shared)[((((((((k_1 & 1) * 8192) + ((((((int)threadIdx.x) >> 6) + 2) & 3) * 2048)) + (i_2 * 512)) + (((((int)threadIdx.x) & 31) >> 4) * 256)) + ((((int)threadIdx.x) & 7) * 32)) + (((((((int)threadIdx.x) & 7) >> 2) + ki) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 8))])), (&(B_local[(i_2 * 8)])));
          }
    ...
    for (int i_4 = 0; i_4 < 16; ++i_4) {
      tl::ptx_stmatrix_m8n8_x4((&(((half_t*)C_shared)[((((((((((int)threadIdx.x) >> 5) * 4096) + ((i_4 >> 2) * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((i_4 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (i_4 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8)) - 16384)])), __pack_half2(((half_t)C_local[(i_4 * 8)]), ((half_t)C_local[((i_4 * 8) + 1)])), __pack_half2(((half_t)C_local[((i_4 * 8) + 2)]), ((half_t)C_local[((i_4 * 8) + 3)])), __pack_half2(((half_t)C_local[((i_4 * 8) + 4)]), ((half_t)C_local[((i_4 * 8) + 5)])), __pack_half2(((half_t)C_local[((i_4 * 8) + 6)]), ((half_t)C_local[((i_4 * 8) + 7)])));
    }
    tl::__sync_thread_partial(3, 256);
